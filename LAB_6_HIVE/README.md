...
```powershell
cd "c:\Users\najia\OneDrive - um5.ac.ma\Desktop\Lab Big data 0"
docker-compose up -d
```
...
Copy-Item -Path "HIVE\data\*" -Destination "C:\Users\najia\OneDrive - um5.ac.ma\Documents\hadoop_project\hive\data\" -Recurse

# Créer le dossier si nécessaire
New-Item -ItemType Directory -Force -Path "C:\Users\najia\OneDrive - um5.ac.ma\Documents\hadoop_project\hive\data"
```

#### 2. Copier les scripts HQL
```powershell
Copy-Item -Path "HIVE\scripts\*" -Destination "C:\Users\najia\OneDrive - um5.ac.ma\Documents\hadoop_project\hive\scripts\" -Recurse

# Créer le dossier si nécessaire
New-Item -ItemType Directory -Force -Path "C:\Users\najia\OneDrive - um5.ac.ma\Documents\hadoop_project\hive\scripts"
```
